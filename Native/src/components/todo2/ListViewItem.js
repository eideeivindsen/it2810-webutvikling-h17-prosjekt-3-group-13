...
class ListViewItem extends Component {
    ...
    render() {
        ...
        return (
            <TouchableHighlight underlayColor={'#eee'} style={{paddingTop: 6, paddingBottom: 6, backgroundColor: "#F8F8F8", borderBottomWidth:1, borderColor: '#00bcd4'}} {...this.props.sortHandlers}>
